...
class IbnabPmanagerBundle implements Migration
{
    ...
    protected function createPDFTemplateTable(Schema $schema)
    {
        ...
        $table->addColumn('margintop', 'integer', ['notnull' => false ,'notnull' => false]);
        $table->addColumn('marginleft', 'integer', ['notnull' => false ,'notnull' => false]);
        $table->addColumn('marginright', 'integer', ['notnull' => false ,'notnull' => false]);
        $table->addColumn('marginbottom', 'integer', ['notnull' => false ,'notnull' => false]);
        $table->addColumn('autobreak', 'boolean', ['notnull' => false ,'notnull' => false]);
        ...
        $table->addIndex(['user_owner_id'], 'IDX_EE2DB9449EB185F9', []);
        $table->addIndex(['organization_id'], 'IDX_EE2DB94432C8A3DE', []);
        
    }

    /**
     * Create ibnab_pmanager_template_translation table
     *
     * @param Schema $schema
     */
    protected function createPDFTemplateTranslationTable(Schema $schema)
    {
        $table = $schema->createTable('ibnab_pmanager_template_translation');
        $table->addColumn('id', 'integer', ['autoincrement' => true]);
        ...
        $table->addColumn('content', 'text', ['notnull' => false]);
        $table->setPrimaryKey(['id']);
        $table->addIndex(['object_id'], 'IDX_B520E901232D562B', []);
        $table->addIndex(['locale','object_ide','field'], 'lookup_unique_idx', []);
    }
    /**
     * Add ibnab_pmanager_template table foreign          
     *
     * @param Schema $schema
     */
    protected function addPDFTemplateTableForeignKeys(Schema $schema)
    {
    ...
    /**
     * Add ibnab_pmanager_template_translation table foreign          
     *
     * @param Schema $schema
     */
    protected function addPDFTemplateTranslationTableForeignKeys(Schema $schema)
    {
        $table = $schema->getTable('ibnab_pmanager_template_translation');
        $table->addForeignKeyConstraint(
